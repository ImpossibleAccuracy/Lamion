package com.application.lamion.data.service.file

import com.application.lamion.data.database.table.FileTypeTable
import com.application.lamion.data.service.file.datasource.FileDataSource
import com.application.lamion.data.service.file.mapper.toLocalFile
import com.application.lamion.data.service.file.utils.replace
import com.application.lamion.domain.model.Id
import com.application.lamion.domain.service.file.FileStorageService
import com.application.lamion.domain.service.file.LocalFile
import com.application.lamion.utils.byteContent
...
class FileStorageServiceImpl(
    ...
    override suspend fun getFileById(id: Id): LocalFile? = dbQuery {
        FileDataSource
            .getFileById(id)
            ?.let {
                it.toLocalFile(
    ...
    override suspend fun findFileByHashOrCreate(file: FilePart): LocalFile {
